...
from apps.usersapp import tasks
...
class Post(models.Model):
    ...
    def add_like(self, user: get_user_model()):
...
class PostView(models.Model):
    ...
    user = models.ForeignKey(get_user_model(), on_delete = models.CASCADE, related_name = "viewer")
